const updateButton = document.getElementById('modifier-etudiant');
updateButton.addEventListener('click', (event) => {
    ...
    axios.patch(baseURL, data).then(response => {
        if (response.data.success) {
            return window.location.href = 'http://localhost:3000/html-files/etudiants/etudiant-modifier.html'
        }
